...
//                System.out.println(minValue+" "+i);
    ...
    public boolean search(String searchTerm) 
    {
        if (getSearchByField() == 0) 
        {
            if (getNumberHash().containsKey(searchTerm)) 
            {
                ...
                System.out.println("Number has been HASHED "+ getFoundIndex());
                // "has been HASHED" doesn't make sense but I am just displaying it to know that the hashMap works for the selected sortFields
                return true;
            }
        }
        if (getSearchByField() == 1) 
        {
            if (getNameHash().containsKey(searchTerm)) 
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("Name has been HASHED " + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 2) 
        {
            if (getPositionHash().containsKey(searchTerm)) 
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("Position has been HASHED" + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 3) 
        {
            if (getHeightHash().containsKey(searchTerm))
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("Height has been HASHED" + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 4) 
        {
            if (getWeightHash().containsKey(searchTerm)) 
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("Weight has been HASHED" + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 5) 
        {
            if (getHomeTownHash().containsKey(searchTerm)) 
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("HomeTown has been HASHED" + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 6) 
        {
            if (getStateHash().containsKey(searchTerm)) 
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("State has been HASHED" + getFoundIndex());
                return true;
            }
        }
        if (getSearchByField() == 7) 
        {
            if (getHighSchoolHash().containsKey(searchTerm))
            {
                ...
                setFound(true);
                setFirstLineToDisplay(getFoundIndex());
                System.out.println("HighSchool has been HASHED" + getFoundIndex());
                return true;
            }
        }
    ...
    public int highlightCalculator() // This method will calculate which row to highlight when the player that was searched is found
    {
        int n = lastLineToDisplay - foundIndex - 1;
        return n;
    }
