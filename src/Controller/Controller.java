            ...
            public void keyPressed(KeyEvent ke) 
            {
                if (ke.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    else
                    {
                        ...
                        int z = model.getFpData().highlightCalculator(); //A new int variable "z" is given the value of the calculated row-to-be-highlighted from FootballPlayerData
                        getView().getIf().getIp().getCp().lineToHighlight(z); //The "z" int variable is passed to the lineToHighlight() method in CenterPanel. So, CenterPanel will know which row it needs to highlight
                    }
                }
            }
